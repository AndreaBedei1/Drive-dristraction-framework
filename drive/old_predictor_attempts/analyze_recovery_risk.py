...
if __name__ == "__main__":
    # 1. Load Data
    try:
        distractions = pd.read_csv(f'{DATA_PATH}Dataset Distractions_distraction_old.csv')
        errors_dist = pd.read_csv(f'{DATA_PATH}Dataset Errors_distraction_old.csv')
        errors_base = pd.read_csv(f'{DATA_PATH}Dataset Errors_baseline_old.csv')
        driving_base = pd.read_csv(f'{DATA_PATH}Dataset Driving Time_baseline_old.csv')
