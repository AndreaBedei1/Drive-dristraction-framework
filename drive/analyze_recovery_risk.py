...
def main() -> None:
    ...
    # ---- User consistency warning ----
    baseline_users = set(baseline_errors["user_id"].unique())
    distraction_users = set(distractions["user_id"].unique())
    warn_missing_users(baseline_users, distraction_users)
